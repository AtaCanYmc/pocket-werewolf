...
export default function DawnPhase() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 space-y-6 animate-fade-in text-center">
      {/* Dawn Header */}
      <div className="bg-gradient-to-b from-amber-500/10 via-surface to-surface border border-amber-500/30 dark:border-amber-900/60 rounded-3xl p-6 shadow-2xl space-y-2">
        <div className="flex items-center justify-center gap-2">
          <Sun className="w-6 h-6 text-amber-500 animate-spin" />
